...
--
-- Host: 127.0.0.1
-- Generation Time: 2017-04-10 18:52:13
...
INSERT INTO `qgs_handtake_place` (`id`, `name`, `address`, `service`, `tel`, `pid`, `sort`, `status`, `shoudan`, `max`) VALUES
...
--
ALTER TABLE `qgs_login_log`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键id',AUTO_INCREMENT=124;
--
