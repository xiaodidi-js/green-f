...
--
-- Host: 127.0.0.1
-- Generation Time: 2017-04-11 18:10:13
...
(1, 'admin', 'e10adc3949ba59abbe56e057f20f883e', 'admin', 'admin@admin.com', '/images/aheads/9.png', 1, 1, 1469160977),
...
) ENGINE=InnoDB AUTO_INCREMENT=37 DEFAULT CHARSET=utf8 COMMENT='后台栏目表';
...
(35, '满就送赠品', 'admin', 'gift', 'maxgift', 34, 1, 1, ''),
(36, '首单赠品', 'admin', 'gift', 'Giftlist', 34, 1, 1, '');
...
CREATE TABLE IF NOT EXISTS `qgs_handtake_place` (
  ...
  `service` varchar(250) NOT NULL COMMENT '服务区域',
  ...
  `status` int(1) NOT NULL DEFAULT '0' COMMENT '状态',
  `shoudan` varchar(250) NOT NULL COMMENT '首单赠品'
...
INSERT INTO `qgs_handtake_place` (`id`, `name`, `address`, `service`, `tel`, `pid`, `sort`, `status`, `shoudan`) VALUES
...
(8, '南区站点测试', '挥洒飞机刷卡缴费的卡是伐啦圣诞节发送卡佛哦啊另外', '', '13047069417', 4, 1, 1, 'a:7:{i:0;s:1:"6";i:1;s:1:"9";i:2;s:2:"10";i:3;s:2:"11";i:4;s:2:"12";i:5;s:2:"13";i:6;s:1:"1";}'),
...
CREATE TABLE IF NOT EXISTS `qgs_kefu` (
  `id` int(11) NOT NULL,
  `class` int(11) NOT NULL COMMENT '<0>QQ<1>tel',
  `num` varchar(50) NOT NULL COMMENT '内容'
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='客服联系表';
...
(121, 1, '127.0.0.1', 1491543777),
(122, 1, '127.0.0.1', 1491621062),
(123, 1, '127.0.0.1', 1491786541),
(124, 1, '127.0.0.1', 1491875482);
...
) ENGINE=InnoDB AUTO_INCREMENT=182 DEFAULT CHARSET=utf8 COMMENT='用户模块|订单商品列表|张盛鸿|2016-11-11';
...
(181, 19, '20020161223220348741', 4, 240.00, 2, '', '');
...
(12, 9, '123', '123', '123', 123.00, '123', 0, 0.00, 0, 0, NULL, 0, 123, '6', 100, 0, 213, '', '["http:\\/\\/qgshop.b0.upaiyun.com\\/2017\\/03\\/25\\/08\\/35\\/55\\/upload_46472382dbe0981119338b7168b20ef4.jpg"]', 0, 0, 0, 1, 0, 0, 1490432542, 1490432542, 0, 2, 4, '3#11,4#22', 1),
(13, 9, '123', '123', '123', 123.00, '123', 0, 0.00, 0, 0, NULL, 0, 123, '6', 1000000, 0, 213, '', '["http:\\/\\/qgshop.b0.upaiyun.com\\/2017\\/03\\/25\\/08\\/35\\/55\\/upload_46472382dbe0981119338b7168b20ef4.jpg"]', 0, 0, 0, 1, 0, 0, 1490432542, 1490432542, 0, 2, 4, '3#11,4#22', 1);
...
) ENGINE=InnoDB AUTO_INCREMENT=136 DEFAULT CHARSET=utf8 COMMENT='商家模块|商品规格属性表|张盛鸿|2016-11-11';
...
--
-- 表的结构 `qgs_since_maxgift`
--

CREATE TABLE IF NOT EXISTS `qgs_since_maxgift` (
  `id` int(11) NOT NULL,
  `maxmoney` float(10,2) NOT NULL COMMENT '满就送金额',
  `useshop` text NOT NULL COMMENT '自提点id',
  `shopid` text NOT NULL COMMENT '商品id'
) ENGINE=MyISAM AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='满就送';

--
-- 转存表中的数据 `qgs_since_maxgift`
--

INSERT INTO `qgs_since_maxgift` (`id`, `maxmoney`, `useshop`, `shopid`) VALUES
(1, 0.00, 'a:3:{i:0;s:1:"9";i:1;s:2:"10";i:2;s:2:"11";}', 'a:3:{i:0;s:1:"1";i:1;s:1:"2";i:2;s:1:"3";}'),
(2, 0.00, 'a:3:{i:0;s:1:"1";i:1;s:1:"2";i:2;s:1:"3";}', 'a:2:{i:0;s:1:"1";i:1;s:1:"2";}'),
(3, 0.00, 'a:3:{i:0;s:1:"1";i:1;s:1:"2";i:2;s:1:"3";}', 'a:3:{i:0;s:1:"3";i:1;s:1:"4";i:2;s:1:"5";}'),
(4, 123.00, 'a:2:{i:0;s:1:"2";i:1;s:1:"1";}', 'a:2:{i:0;s:1:"1";i:1;s:1:"2";}'),
(5, 0.00, 'a:1:{i:0;s:0:"";}', 'a:1:{i:0;s:1:"6";}'),
(6, 0.00, 'a:1:{i:0;s:0:"";}', 'a:1:{i:0;s:1:"6";}'),
(7, 0.00, 'a:2:{i:0;s:2:"11";i:1;s:2:"10";}', 'a:3:{i:0;s:1:"1";i:1;s:1:"2";i:2;s:1:"3";}'),
(8, 0.00, 'a:3:{i:0;s:1:"1";i:1;s:1:"2";i:2;s:1:"3";}', 'a:2:{i:0;s:1:"1";i:1;s:1:"2";}'),
(9, 0.00, 'a:1:{i:0;s:1:"1";}', 'a:2:{i:0;s:1:"6";i:1;s:1:"5";}'),
(10, 1221.00, 'a:2:{i:0;s:1:"8";i:1;s:1:"9";}', 'a:3:{i:0;s:1:"1";i:1;s:1:"6";i:2;s:1:"5";}');
...
--
-- Indexes for table `qgs_since_maxgift`
--
ALTER TABLE `qgs_since_maxgift`
  ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `qgs_column`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键id',AUTO_INCREMENT=37;
--
...
--
ALTER TABLE `qgs_login_log`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键id',AUTO_INCREMENT=125;
--
...
--
ALTER TABLE `qgs_member_orderlist`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id',AUTO_INCREMENT=182;
--
...
--
ALTER TABLE `qgs_product_formvalue`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id',AUTO_INCREMENT=136;
--
...
--
-- AUTO_INCREMENT for table `qgs_since_maxgift`
--
ALTER TABLE `qgs_since_maxgift`
